...
<acme:form>
	<acme:input-textarea code="administrator.aircraft.form.label.model" path="model"/>  
	<acme:input-textarea code="administrator.aircraft.form.label.registrationNumber" path="registrationNumber"/>
	<acme:input-textarea code="administrator.aircraft.form.label.capacity" path="capacity"/>
	<acme:input-textarea code="administrator.aircraft.form.label.cargoWeight" path="cargoWeight"/>
