...
<acme:form>
	...
	<acme:input-moment code="administrator.airlines.form.label.foundationMoment" path="foundationMoment" readonly="true"/>
	</jstl:if>
	...
	<jstl:choose>	
		<jstl:when test="${acme:anyOf(_command, 'show|update')}">
			...
			<acme:button code="administrator.airlines.form.button.back" action="/administrator/airlines/list"/>
