...
public interface FlightAssignmentRepository extends AbstractRepository {
	...
	@Query("select f From FlightAssignment f where f.duty = :duty and f.leg.id = :legId and f.id != :assignmentId")
	Collection<FlightAssignment> findDutyAlreadyInLeg(Duty duty, int legId, int assignmentId);
}
